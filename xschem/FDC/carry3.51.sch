...
S {}
E {}
N -470 -530 -410 -530 { lab=clk}
N -470 -510 -410 -510 { lab=carry}
N -440 -490 -410 -490 { lab=reset}
N -230 -530 -210 -530 { lab=#net1}
N -210 -530 -210 -510 { lab=#net1}
N -210 -510 -180 -510 { lab=#net1}
N -200 -530 -180 -530 { lab=clk}
...
N 240 -590 240 -530 { lab=clk}
N 460 -580 460 -530 { lab=clk}
N 670 -580 670 -530 { lab=clk}
N 890 -580 890 -530 { lab=clk}
N 1110 -590 1110 -530 { lab=clk}
N 1330 -590 1330 -530 { lab=clk}
...
N 1510 -530 1520 -530 { lab=out}
N -440 -490 -440 -450 { lab=reset}
N -440 -450 -170 -450 { lab=reset}
N -170 -460 -170 -450 { lab=reset}
N 1520 -530 1580 -530 { lab=out}
C {sky130_stdcells/dfrtp_1.sym} -320 -510 0 0 {name=x1 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hvl__ }
C {devices/lab_pin.sym} -440 -530 1 0 {name=l3 sig_type=std_logic lab=clk}
C {devices/ipin.sym} -460 -530 0 0 {name=p4 lab=clk}
C {devices/lab_pin.sym} -450 -510 3 0 {name=l4 sig_type=std_logic lab=carry}
C {sky130_stdcells/dfrtp_1.sym} -90 -510 0 0 {name=x3 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hvl__ }
C {devices/lab_pin.sym} -190 -530 1 0 {name=l42 sig_type=std_logic lab=clk}
C {sky130_stdcells/dfrtp_1.sym} 120 -510 0 0 {name=x4 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hvl__ }
C {devices/lab_pin.sym} 30 -590 2 0 {name=l43 sig_type=std_logic lab=clk}
...
C {devices/lab_pin.sym} 240 -580 2 0 {name=l44 sig_type=std_logic lab=clk}
C {devices/lab_pin.sym} 460 -570 2 0 {name=l45 sig_type=std_logic lab=clk}
C {devices/lab_pin.sym} 670 -570 2 0 {name=l46 sig_type=std_logic lab=clk}
C {devices/lab_pin.sym} 890 -570 2 0 {name=l47 sig_type=std_logic lab=clk}
C {devices/lab_pin.sym} 1110 -570 2 0 {name=l48 sig_type=std_logic lab=clk}
C {devices/lab_pin.sym} 1330 -570 2 0 {name=l49 sig_type=std_logic lab=clk}
C {devices/ipin.sym} -190 -460 0 0 {name=p1 lab=reset}
C {devices/lab_pin.sym} 10 -460 1 0 {name=l1 sig_type=std_logic lab=reset}
C {devices/ipin.sym} -460 -510 0 0 {name=p3 lab=carry}
...
C {devices/opin.sym} 1570 -530 0 0 {name=p5 lab=out}
C {devices/lab_pin.sym} 1540 -530 1 0 {name=l12 sig_type=std_logic lab=out}
