...
N -560 60 -560 80 { lab=#net4}
N -560 30 -540 30 { lab=#net4}
N -540 30 -540 80 { lab=#net4}
...
N -940 -320 -940 -270 { lab=#net3}
N -1020 -350 -980 -350 { lab=in1}
N -940 -270 -800 -270 { lab=#net3}
N -910 -390 -800 -390 { lab=vdd}
N -560 160 -560 180 { lab=GND}
N -560 130 -540 130 { lab=GND}
N -540 130 -540 180 { lab=GND}
N -640 130 -600 130 { lab=in4}
N -560 80 -560 100 { lab=#net4}
N -560 180 -450 180 { lab=GND}
N -450 180 -440 180 { lab=GND}
N -440 80 -440 180 { lab=GND}
N -560 80 -540 80 { lab=#net4}
...
C {devices/gnd.sym} -500 180 0 0 {name=l5 lab=GND}
